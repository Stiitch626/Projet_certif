...
<p> Plan crèche avec capteur du type sélectionner précédemment</p>
		...
		<table>
				...
				<form action="">
					<td><input type="radio" name="valeur" value="Température" id="Température" /> <label for="Température">Température</label><br />
					<input type="radio" name="valeur" value="Humidité" id="Humidité" /> <label for="Humidité">Humidité</label><br /></td>
					<td><input type="radio" name="valeur" value="Température2" id="Température2" /> <label for="Température2">Température</label><br />
					<input type="radio" name="valeur" value="Humidité2" id="Humidité2" /> <label for="Humidité2">Humidité</label><br /></td>
				</form>
