...
<input type="button" name="lien1" value="Home" onclick="self.location.href='Home'" style="background-color:#6943D0" style="color:white; font-weight:bold"onclick>

<table><td><?= $this->Html->image('plan_puit.png');?></td></table>
	</div>
<div id="apparition">								
		<br />
		<table id="zoneP">
...
<input type="button" name="lien1" value="Suivant" onclick="self.location.href='Recapitulatifs';return_selection()" style="background-color:#6943D0" style="color:white; font-weight:bold"onclick>